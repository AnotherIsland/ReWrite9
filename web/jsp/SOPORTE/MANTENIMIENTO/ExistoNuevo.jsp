            ...
            <div class="row">
                <div class="col s12 m12 l12 xl12">
                    <div class="section white z-depth-3 center-align">
                        <h1 >Levantar Reporte de Mantenimiento</h1>  
                        <!--<h6>Inicia sesión</h6>  -->
                    </div>
                    <br>
                    <div class="col s4 m4 l4 xl4 " >
                        <div class="section grey z-depth-3">
                            <div class="row center-align">
                                <h4 class="white-text">Desde Reporte de Evento Existente</h4><hr class="blue lighten-1">
                                <div class="col s12 m12 l12 xl12 " >
                                    <form action="${pageContext.request.contextPath}/jsp/SOPORTE/MANTENIMIENTO/LevantarReporte.jsp">
                    ...
                    <div class="col s4 m4 l4 xl4 " >
                        <div class="section grey z-depth-3">
                            <div class="row center-align">
                                <h2 class="white-text">Desde cero</h2><hr class="blue lighten-1">
                                <div class="col s12 m12 l12 xl12 " >
                                    <form action="${pageContext.request.contextPath}/jsp/SOPORTE/MANTENIMIENTO/ReporteDe0.jsp">
                                    <div class="input-field col s12 center-align">
