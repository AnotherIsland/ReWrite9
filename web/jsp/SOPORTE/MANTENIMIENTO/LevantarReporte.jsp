            ...
            <div class="row">
                <div class="col s12 m12 l12 xl12">
                    <div class="section white z-depth-3 center-align">
                        <h4 >Levantar Reporte De Mantenimiento</h4>  
                    </div>
                ...
                <div class="col s12 m12 l12 xl12 " >
                    <div class="section white z-depth-3">
                        ...
                        <div class="row">
                            <form name="reporte" action="${pageContext.request.contextPath}/AltaMantenimiento" method="POST">
                                <div class="row">
                                    ...
                                    <div class="col s5 l5 m5 xl5">
                                        <select id="ReporteExistente"  name="ReporteExistente" >
                                          ...
                                          rs=db.query("Select * from reporte;");
                                          while(rs.next()){
                                              
                                          int ini= rs.getInt("idreporte");
