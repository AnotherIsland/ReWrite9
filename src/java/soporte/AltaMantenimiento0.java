 ...
 * @author HP-PC
 */
public class AltaMantenimiento0 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            db.connect();   
            db.insert("INSERT INTO reporteMant(contenido,fecha_inicio,idUsuario1Levanta,idUsuario1Asigna) VALUES('"+contenido+"', current_date() ,"+4+","+persona+");");
